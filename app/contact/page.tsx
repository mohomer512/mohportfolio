          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <input
                ...
                className="w-full bg-white/5 border-b-2 border-gray-700 text-white p-4 rounded-lg focus:outline-none focus:border-pink-500 transition-colors"
              />
              <input
                type="email"
                name="email"
            ...
            <textarea
              ...
              onChange={handleChange}
              className="w-full bg-white/5 border-b-2 border-gray-700 text-white p-4 rounded-lg focus:outline-none focus:border-pink-500 transition-colors resize-none"
            />
            <button
              type="submit"
              className="w-full md:w-auto px-8 py-4 bg-pink-500 text-white font-bold rounded-lg hover:bg-pink-600 transition-colors"
            >
              Send Message
            </button>
          </form>
